...
DATA$ANC_F_NUM<-((DATA$m1SSRes-DATA$m2SSRes)/DATA$m1SSRes)/1
DATA$ANC_F_DENOM<-(1-((DATA$m1SSRes-DATA$m2SSRes)/DATA$m1SSRes))/(40-3)
DATA$ANC_Fobs<-DATA$ANC_F_NUM/DATA$ANC_F_DENOM #Calculate F Observed for the ANCOVA model.
DATA$ANC_Sig<-as.numeric(DATA$ANC_Fobs>qf(0.957,1,37))

DATA$RMr2<-(DATA$m3SSRes-DATA$m4SSRes)/DATA$m3SSRes
DATA$RM_F_NUM<-((DATA$m3SSRes-DATA$m4SSRes)/DATA$m3SSRes)/1
DATA$RM_F_DENOM<-(1-((DATA$m3SSRes-DATA$m4SSRes)/DATA$m3SSRes))/(40-2)
DATA$RM_Fobs<-DATA$RM_F_NUM/DATA$RM_F_DENOM #Calculate F Observed for the RM ANOVA model.
DATA$RM_Sig<-as.numeric(DATA$RM_Fobs>qf(0.957,1,38))
